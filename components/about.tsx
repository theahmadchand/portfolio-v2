    ...
    return (
        ...
        >
            ...
            <p className="mb-3">
                ...
                {` the feeling of finally figuring out a solution to a problem. My
                core stack is `}
            ...
            <p>
                ...
                and playing with my dog. I also enjoy <span className="font-medium">learning new things</span>. I am
                currently learning about <span className="font-medium">history and philosophy</span>
                {`. I'm also learning
